...
Описание текущего проекта доступно по ссылке: https://dmitrypetukhov90.pythonanywhere.com/swagger/  (пока не работает - нужно подключить аутентификацию).
